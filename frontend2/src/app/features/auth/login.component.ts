          ...
          <div class="glass-panel p-12 rounded-3xl">
            ...
            <div class="text-center mb-10">
              ...
              <p class="text-lg text-gray-300 font-light">
                Ulogujte se da nastavite svoju avanturu kroz svet putovanja
              </p>
            </div>
            ...
            <form class="space-y-8" [formGroup]="loginForm" (ngSubmit)="onSubmit()">
              ...
              <div class="space-y-3">
                ...
                <div class="relative">
                  ...
                  />
                  <div class="absolute inset-0 bg-gradient-to-r from-blue-400/10 to-green-400/10 rounded-2xl pointer-events-none opacity-0 group-focus-within:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
