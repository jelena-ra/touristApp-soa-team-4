...
type Tour struct {
	...
	TravelTimes   map[string]string      `protobuf:"bytes,9,rep,name=travelTimes,proto3" json:"travelTimes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Tour) GetTravelTimes() map[string]string {
	if x != nil {
