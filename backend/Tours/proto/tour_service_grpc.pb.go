...
type TourServiceClient interface {
	...
	GetTourByID(ctx context.Context, in *TourIDRequest, opts ...grpc.CallOption) (*TourResponse, error)
...
func (c *tourServiceClient) GetTourByID(ctx context.Context, in *TourIDRequest, opts ...grpc.CallOption) (*TourResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TourServiceServer interface {
	...
	GetTourByID(context.Context, *TourIDRequest) (*TourResponse, error)
...
func (UnimplementedTourServiceServer) GetTourByID(context.Context, *TourIDRequest) (*TourResponse, error) {
